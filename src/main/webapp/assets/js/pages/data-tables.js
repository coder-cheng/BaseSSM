...
$('#datatable').dataTable({
    ...
    "oLanguage": {
	    "sSearch": "",
	    "sLengthMenu": "<span>条目数:</span>_MENU_"
	},
	"bJQueryUI": false,
	"bAutoWidth": false,
	"sDom": "<'row'<'col-lg-4 col-md-5 col-sm-6 text-center'l><'col-lg-4 col-md-5 col-sm-6 text-center'f>r>t<'row-'<'col-lg-6 col-md-6 col-sm-12'i><'col-lg-6 col-md-6 col-sm-12'p>>",
});
...
$('#datatable1').dataTable({
	...
	"bJQueryUI": false,
	"bAutoWidth": false,
	"sDom": "<'row'<'col-lg-4 col-md-5 col-sm-6 text-center'l><'col-lg-4 col-md-5 col-sm-6 text-center'T><'col-lg-3 col-md-3 col-sm-12 text-center'f>r>t<'row-'<'col-lg-6 col-md-6 col-sm-12'i><'col-lg-6 col-md-6 col-sm-12'p>>",
	"oTableTools": {
